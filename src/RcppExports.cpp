...
// detail_make_index_impl1_serial
List detail_make_index_impl1_serial(DataFrame data, CharacterVector by);
RcppExport SEXP parallelGroupBy_detail_make_index_impl1_serial(SEXP dataSEXP, SEXP bySEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        Rcpp::RNGScope __rngScope;
        Rcpp::traits::input_parameter< DataFrame >::type data(dataSEXP );
        Rcpp::traits::input_parameter< CharacterVector >::type by(bySEXP );
        List __result = detail_make_index_impl1_serial(data, by);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
...
// detail_make_index_parallel
List detail_make_index_parallel(DataFrame data, CharacterVector by);
RcppExport SEXP parallelGroupBy_detail_make_index_parallel(SEXP dataSEXP, SEXP bySEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        Rcpp::RNGScope __rngScope;
        Rcpp::traits::input_parameter< DataFrame >::type data(dataSEXP );
        Rcpp::traits::input_parameter< CharacterVector >::type by(bySEXP );
        List __result = detail_make_index_parallel(data, by);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
